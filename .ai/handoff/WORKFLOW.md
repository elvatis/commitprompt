...
| ---------- | --------------------------- | ----------- | -------------------------------------------------- |
| 🔭 Sonar   | perplexity/sonar-pro        | Researcher  | npm ecosystem, git tooling docs, OSS gaps          |
...
### 1: Research (Sonar)
Reads `NEXT_ACTIONS.md`. Searches for: existing tools in the space, relevant npm packages, git diff API docs. Writes findings to `LOG.md`.
...
Format: `✅ commitprompt [feature] done - Branch: feat/... - Tests: X/X`
